...
try:
    ...
    m1 = Socio('Paulo', '649.943.670-43', '10/09/1990', 1, 2020)
    ...
    m2 = Socio('Ana', '918.199.320-01', '14/12/1995', 2, 2020)
    assert m2.nome == 'Ana'
    ...
    m3 = Socio('Maria', '770.046.380-81', '14/01/2002', 3, 2020)
    m4 = Socio('Vinicius', '682.194.070-34', '14/05/1989', 4, 2020)
    m5 = Socio('Guilherme', '001.655.780-84', '14/02/1987', 3, 2020)
    m6 = Socio('Ruan', '157.550.560-64', '14/10/2000', 1, 2019)
    m7 = Socio('Caroline', '548.428.380-94', '14/09/2001', 1, 2018)
    m8 = Socio('Fernanda', '023.126.550-63', '14/09/2005', 3, 2020)
    m9 = Socio('Zé', '012.308.030-41', '14/07/1990', 3, 2020)
...
try:
    ...
    print('CORRETO: gerou exceção TypeError para mês inválido no \
método mes_associacao')
except Exception:
    print('ERRO...: não gerou exceção TypeError para mês inválido no \
método mes_associacao')
else:
    print('ERRO...: não gerou exceção TypeError para mês inválido no \
método mes_associacao')
...
try:
    ...
    print('CORRETO: gerou exceção ValueError para ano inválido no \
método mes_associacao')
except Exception:
    print('ERRO...: não gerou exceção ValueError para ano inválido no \
método mes_associacao')
else:
    print('ERRO...: não gerou exceção ValueError para ano inválido no \
método mes_associacao')
...
try:
    ...
    print('ERRO...: método expulsar não retornou lista correta ou não \
